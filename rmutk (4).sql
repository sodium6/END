...
;
INSERT INTO `activity_upload`
VALUES (
    10,
    4,
    3,
    '/uploads/portfolio_image/S__19800114_20251001154820960.jpg'
  ),
  (
    11,
    4,
    3,
    '/uploads/portfolio_image/logoo_20251002050652643.png'
  ),
  (
    16,
    6,
    16,
    '/uploads/portfolio_image/Beatrix-logo-2_20260204081303489.png'
  );
...
VALUES (
    ...
    '$2b$10$TF30y2AI1EW62QE/QXxOC.zJHZ3NI3/sVJpcHojoltG1.eVhd1gQy',
    'System Super Admin',
    'superadmin',
    'active',
    '2026-02-04 05:23:30',
  ...
  (
    ...
    'admin',
    'admin@example.com',
    '$2b$10$yVK78nTVQSAlucR0hgHfUeid4msoL4xn/WhpE6k0p5AL3Okbl85Ya',
...
VALUES (
    ...
    'T',
    '',
    '/uploads/certificates/1759380811234-f6c5b90oq8j.jpg',
    '2025-10-02 04:53:31'
  ),
  (
    3,
    ...
    'Tt',
    '',
    '/uploads/certificates/1759381471812-f69jottyoqv.jpg',
    '2025-10-02 05:04:31'
  ),
  (
    4,
    ...
    'ธ',
    '',
    '/uploads/certificates/1759381693013-lykbvfezvzh.png',
    '2025-10-02 05:08:13'
  ),
  (
    5,
    ...
    'ธ',
    'T',
    '/uploads/certificates/1759381999357-pu8wujpr2jf.png',
    '2025-10-02 05:09:47'
  ),
  (
    6,
    16,
    'Advanced ReactReact Course',
    '2024, Online',
    '/uploads/certificates/1770194925631-n3movcmjn0n.png',
    '2026-02-04 08:48:46'
  );
...
VALUES (
    2,
    'big@gmail.com',
    '$2b$10$DW2Kiamn3smz7NvByItY4eqRzB72pL8e7rwoULiYfcGzHIhW9HusG',
    '2026-02-03 05:37:07',
    '2026-02-03 05:22:07'
  );
...
VALUES (
    ...
    3,
    3,
    '/uploads/portfolio_image/รูปภาพ1_20250920102030118.png'
  ),
  (
    17,
    2,
    3,
    '/uploads/portfolio_image/สนเน_20250927075950209.png'
  ),
  (
    18,
    4,
    3,
    '/uploads/portfolio_image/รูปภาพ1_20250930153013137.png'
  );
...
CREATE TABLE `news` (
  ...
  CONSTRAINT `fk_news_category` FOREIGN KEY (`category_id`) REFERENCES `news_categories` (`category_id`) ON DELETE
  SET NULL,
...
VALUES (
  ...
  (
    ...
    'published',
    'announcement',
    '/uploads/news/1770185348722-168455--2569-01-28-13-28-07.png',
    '2025-09-30 15:36:36',
    '2026-02-04 06:09:08',
    NULL
  ),
  (
    4,
    'Test News Edited',
    'Edited content.ฟหกฟหกฟห',
    1,
    'published',
    NULL,
    '/uploads/news/1770185329401-283302--2569-01-28-13-28-07.png',
    '2026-02-04 05:25:03',
    '2026-02-04 06:08:49',
    5
  ),
...
VALUES (
    2,
    2,
    '$2b$10$KUYmXwr3MwGhMegmyts/JuCwbwEMbzq0F0nY0gZtwg9BT8NelAhGa',
    '2025-10-01 18:34:07',
    1,
    '2025-10-01 18:24:33',
    '$2b$10$SfAXjQX2S5BUxHkv0tlAK.5Bz2VbuZTANVBwciO0z1zrl1X/YCAl2',
    '2025-10-01 18:39:33',
    '2025-10-01 18:24:40',
    '::1',
    '2025-10-01 11:24:06'
  ...
  (
    8,
    14,
    '$2b$10$Bz9lE63YcEg7AopOzgH3k.UwTBD7tNIeqO8bSmfv0/GAID2rCuLge',
    '2026-02-03 16:07:58',
    0,
    '2026-02-03 16:00:41',
    '$2b$10$jrd/vdpe0rfjzeGtOMDFv.09EFTHfzFt1JwEnPOMQBFjA5zavYvSO',
    '2026-02-03 16:15:42',
    '2026-02-03 16:01:00',
    '::ffff:192.168.65.1',
    '2026-02-03 15:57:58'
...
VALUES (
    ...
    'student',
    'ปวช.',
    '$2b$12$86WhjCXoU1i5j4TQfYCWcOQn/Qbw4/PCk5unqLfBWSCAIGP4i2kgS',
    '2025-09-18 16:11:21',
    '66605100039-4',
    '666051000394',
    'active',
  ...
  (
    3,
    '/uploads/profile_pics/profile-1770130276787-958548018.png',
    'นาย',
    'ทดสอบ',
    'ครับผม',
    'Test',
    ...
    '0812345678',
    'test_line_id',
    '123/456 ถ.ทดสอบ แขวงทดสอบ เขตทดสอบ',
    'กรุงเทพมหานคร',
    'test@gmail.com',
    'student',
    'ม.6',
    '$2b$10$pBtsNwM729BfAi2HoAvNse9RzizbQ5CW2I4wfXKZQT1ssfgjPJtMG',
    '2025-09-19 11:57:06',
    '66605100039-5',
    '666051000395',
    'active',
  ...
  (
    ...
    NULL,
    NULL,
    'nongearth99@gmail.com',
    'student',
    'ปวช.',
    '$2b$12$1aImUBqxRuoIyTTYl.hIGOHARGAz/y9V16wl3H5GvtPEOjybKcCTK',
    '2026-02-03 15:25:34',
    '64110116600-4',
    '641101166004',
    'active',
  ...
  (
    15,
    '/uploads/profile_pics/profile-1770134812404-581463267.png',
    'นาย',
    'หิรัญ',
    'ชัย',
    'หิรัญ',
    ...
    NULL,
    NULL,
    'HirunChaichareonswad@outlook.com',
    'alumni',
    'ม.6',
    '$2b$10$1s1hM0w.SpGXNZWdUEJ41OP4fucsJmFH/QQX3F3RueOBPXYrxPdAO',
    '2026-02-03 16:05:03',
    '64110116600-2',
    '641101166002',
    'active',
  ...
  (
    ...
    'student',
    'Test Edu',
    '$2b$10$oeLQmvRbXc3yxin7N4u.OuM44JyalBA7STEwuz0czWyR/E1.m0tsO',
    '2026-02-04 06:37:32',
    'TEST002',
    'TEST002',
    'active',
